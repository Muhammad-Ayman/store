...
type ProductFormValues = z.infer<typeof formSchema0>
...
export const ProductForm: React.FC<ProductFormProps> = ({
   ...
   const formSchema = initialData ? formSchema0 : formSchema1
   ...
   const defaultValues = initialData
      ...
      : {
           ...
           isFeatured: false,
           isAvailable: false,
           brandId: 'cm3xfktwb000dn84e1tr5i121',
        }
